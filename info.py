...
BOT_TOKEN = '5040662195:AAG5DtlmIm_7oxUWMj3osEYURb8Vi-SNaoU'
...
ADMINS = 1250003833
NULL = [int(null) if id_pattern.search(null) else null for adminnull in environ.get('NULL', '').split()]
...
LOG_CHANNEL = '-1001504830917'
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'HagadMansaChat')
